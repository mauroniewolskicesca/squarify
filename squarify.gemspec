...
require_relative "lib/squarify/version"

Gem::Specification.new do |spec|
  spec.name          = "squarify"
  spec.version       = Squarify::VERSION
  spec.authors       = ["Mauro Niewolski"]
  spec.email         = ["contact@mauroniewolskicesca.com"]
  ...
  spec.metadata["changelog_uri"] = "https://github.com/mauroniewolskicesca/squarify/blob/main/README.md"
